...
public class LocalPlayer : Player
{
	...
	public static Vector2 NormalizeVelocity(Vector2 velocity, Vector2 maxVelocity, float deltaTime)
	{
	...
	public static Vector2 SubstractVelocity(Vector2 velocity, float deltaTime, Vector2 speed)
	{
